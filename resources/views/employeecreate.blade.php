...
<div class="mb-3">
  ...
  <div class="card">
        ...
        <input name="StartDate" id="input-date1" class="form-control input-mask" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="dd/mm/yyyy" value="{{old('StartDate')}}" im-insert="false" required="">
                 <span class="text-muted">e.g "dd/mm/yyyy"</span>
                                        </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="SalaryType" value="{{old('SalaryType')}} " placeholder="Cash/Bank">
                                        </div>
