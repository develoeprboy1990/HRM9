                    ...
                    <div class="card ">
                        <div class="card-body">
                            <h4 class="card-title mb-4"></h4>
                                <form action="{{URL('/FCBAdd')}}" method="post">
                                    {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                         ...
                                         <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group" id="datepicker2">
                                                    <input type="text" name="Date" value="{{$today_date}}" autocomplete="off" class="form-control" placeholder="dd/mm/yyyy" data-date-format="dd/mm/yyyy" data-date-container="#datepicker2" data-provide="datepicker" data-date-autoclose="true">
