...
@section('title', 'Live Account Listing')
@section('content')
 <div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Live Account Listing</h4>
    ...
    <div class="card ">
        ...
        <!-- end card body -->
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Live Account</h4>
     ...
     $(document).ready(function(){
        ...
        $(document.body).on('click','.filter',function(){
            ...
            $('.datatable').DataTable({
                ...
                "destroy": true,
                ajax: {
                url: '{{ url("filterWiseLiveAccountListing") }}',
                data: function (d) {
